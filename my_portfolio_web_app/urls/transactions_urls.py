...
urlpatterns = [
    ...
    path('transactions/delete/purchase/<int:pk>/', TransactionDeleteView.as_view(model=Purchase),
         name='purchase_delete'),
    path('transactions/delete/sale/<int:pk>/', TransactionDeleteView.as_view(model=Sale), name='sale_delete'),
    path('transactions/delete/inflow/<int:pk>/', TransactionDeleteView.as_view(model=Inflow), name='inflow_delete'),
    path('transactions/delete/outflow/<int:pk>/', TransactionDeleteView.as_view(model=Outflow), name='outflow_delete'),
    path('transactions/delete/coupon_clipping/<int:pk>/', TransactionDeleteView.as_view(model=CouponClipping),
         name='coupon_clipping_delete'),
    path('transactions/delete/stock_dividend/<int:pk>/', TransactionDeleteView.as_view(model=StockDividend),
