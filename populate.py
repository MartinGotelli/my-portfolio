...
if __name__ == '__main__':
    ...
    cp21o = Bond(code='CP21O', description='ON CIA GRAL.COMBUS. CL21 V.10/06/23 U$S', maturity_date=date(2023, 6, 10))
    gd30 = Bond(code='GD30', description='Bonos Rep. Arg. U$S Step Up V.09/07/30', maturity_date=date(2030, 7, 9))
    gd35 = Bond(code='GD35', description='Bonos Rep. Arg. U$S Step Up V.09/07/35', maturity_date=date(2035, 7, 9))
    ...
    t107 = StockDividend(date=date(2021, 6, 2), security_quantity=0.68, financial_instrument=dollars,
                         referenced_financial_instrument=intc, broker=IOL, commissions=ars(0.82), account=martin)
    t108 = Purchase(date=date(2021, 6, 4), security_quantity=581, financial_instrument=cp21o, price=usd(1),
                    broker=BALANZ, commissions=ars(0), account=martin)
    t109 = StockDividend(date=date(2021, 6, 7), security_quantity=1.32, financial_instrument=dollars,
                         referenced_financial_instrument=pfe, broker=IOL, commissions=ars(1.60), account=martin)
    t110 = StockDividend(date=date(2021, 6, 23), security_quantity=0.65, financial_instrument=dollars,
                         referenced_financial_instrument=gold, broker=IOL, commissions=ars(0.79), account=martin)
    t111 = StockDividend(date=date(2021, 6, 23), security_quantity=0.47, financial_instrument=dollars,
                         referenced_financial_instrument=gold, broker=IOL, commissions=ars(0.57), account=andres)
    t112 = StockDividend(date=date(2021, 6, 23), security_quantity=0.12, financial_instrument=dollars,
                         referenced_financial_instrument=gold, broker=IOL, commissions=ars(0.14), account=pablo)
    t113 = StockDividend(date=date(2021, 6, 23), security_quantity=1.55, financial_instrument=dollars,
                         referenced_financial_instrument=gold, broker=IOL, commissions=ars(1.88), account=martin)
    t114 = StockDividend(date=date(2021, 6, 23), security_quantity=1.12, financial_instrument=dollars,
                         referenced_financial_instrument=gold, broker=IOL, commissions=ars(1.36), account=andres)
    t115 = StockDividend(date=date(2021, 6, 23), security_quantity=0.28, financial_instrument=dollars,
                         referenced_financial_instrument=gold, broker=IOL, commissions=ars(0.34), account=pablo)
    t116 = StockDividend(date=date(2021, 7, 7), security_quantity=0.67, financial_instrument=dollars,
                         referenced_financial_instrument=ko, broker=IOL, commissions=ars(0.82), account=andres)
    t117 = StockDividend(date=date(2021, 7, 15), security_quantity=1.12, financial_instrument=dollars,
                         referenced_financial_instrument=auy, broker=IOL, commissions=ars(1.37), account=martin)
    t118 = CouponClipping(date=date(2021, 7, 26), security_quantity=36.74, financial_instrument=dollars,
                          referenced_financial_instrument=ptsto, broker=BALANZ, commissions=ars(12.44),
                          account=martin)  # DÓLAR CABLE
    t119 = StockDividend(date=date(2021, 7, 30), security_quantity=1.96, financial_instrument=dollars,
                         referenced_financial_instrument=arco, broker=IOL, commissions=ars(0.61), account=pablo)
    t120 = Purchase(date=date(2021, 8, 18), security_quantity=14, financial_instrument=abev, price=ars(1600),
                    broker=IOL, commissions=ars(157.20), account=martin)
    t121 = Purchase(date=date(2021, 8, 18), security_quantity=33, financial_instrument=gd30, price=ars(0),
                    broker=IOL, commissions=ars(0.61), account=martin)
    t122 = Purchase(date=date(2021, 8, 18), security_quantity=16, financial_instrument=gd35, price=ars(0),
                    broker=IOL, commissions=ars(0.61), account=martin)
    t123 = CouponClipping(date=date(2021, 8, 18), security_quantity=28.32, financial_instrument=dollars,
                          referenced_financial_instrument=csdoo, broker=BALANZ, commissions=ars(1.17),
                          account=martin)
    t124 = CouponClipping(date=date(2021, 8, 18), security_quantity=13.87, financial_instrument=dollars,
                          referenced_financial_instrument=csdoo, broker=BALANZ, commissions=ars(4.98),
                          account=andres)
    t125 = CouponClipping(date=date(2021, 8, 18), security_quantity=28.55, financial_instrument=dollars,
                          referenced_financial_instrument=csdoo, broker=BALANZ, commissions=ars(10.25),
                          account=pablo)
    t126 = CouponClipping(date=date(2021, 8, 19), security_quantity=7.70, financial_instrument=dollars,
                          referenced_financial_instrument=irc9o, broker=BALANZ, commissions=ars(2.63),
                          account=martin)  # DÓLAR CABLE
    t127 = Purchase(date=date(2021, 8, 25), security_quantity=11, financial_instrument=baba, price=ars(3360),
                    broker=IOL, commissions=ars(258.99), account=martin)
    t128 = Purchase(date=date(2021, 8, 25), security_quantity=12, financial_instrument=baba, price=ars(3275),
                    broker=IOL, commissions=ars(275.81), account=martin)
    t129 = Purchase(date=date(2021, 8, 26), security_quantity=165, financial_instrument=csdoo, price=ars(167.5),
                    broker=BALANZ, commissions=ars(166.11), account=pablo)
    ...
    d57 = Inflow(date=date(2021, 6, 1), security_quantity=0.01, financial_instrument=dollars,
                 broker=IOL, account=martin)  # Cuenta remunerada
    d58 = Inflow(date=date(2021, 6, 3), security_quantity=849.40, financial_instrument=dollars, broker=BALANZ,
                 account=martin)  # Depósito
    d59 = Inflow(date=date(2021, 7, 1), security_quantity=266.79, financial_instrument=pesos,
                 broker=IOL, account=martin)  # Cuenta remunerada
    d60 = Inflow(date=date(2021, 7, 1), security_quantity=0.01, financial_instrument=dollars,
                 broker=IOL, account=martin)  # Cuenta remunerada
    d61 = Inflow(date=date(2021, 8, 1), security_quantity=147.73, financial_instrument=pesos,
                 broker=IOL, account=martin)  # Cuenta remunerada
    d62 = Inflow(date=date(2021, 8, 1), security_quantity=0.02, financial_instrument=dollars,
                 broker=IOL, account=martin)  # Cuenta remunerada
    d63 = Inflow(date=date(2021, 8, 17), security_quantity=100000, financial_instrument=pesos, broker=IOL,
                 account=martin)  # Depósito
